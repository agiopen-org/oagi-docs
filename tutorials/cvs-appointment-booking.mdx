...
Break the appointment journey into todos so failures surface at the right granularity.
...
Modeling steps as todos mirrors Tasker’s internal memory model, giving you granular success/failure signals instead of a monolithic “pass/fail.”
