...
Build a TaskerAgent that automates product research on Amazon—navigating to the site, searching for products, and sorting by best sellers.
...
2. **Python ≥ 3.10**:
   ...
   ```
3. **A web browser** – The agent will open new tabs and navigate to Amazon.
...
### Step 2 — Define the crawling workflow
...
### Step 5 — Export execution history
...
3. **Add more todos** – Paginate through results or compare multiple products
