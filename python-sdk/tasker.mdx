...
1. **Set Task** - Define task and todos
...
2. **Set appropriate reflection intervals** - More frequent for complex tasks
3. **Use descriptive task descriptions** - Help the planner understand context
4. **Monitor memory state** - Check todo status and execution history
