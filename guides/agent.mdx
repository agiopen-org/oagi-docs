...
- Breaks work into todos using an internal Planner/Memory system
...
1. **PlannerMemory** stores the overall task, todos, and execution history.
2. `TaskerAgent.set_task()` seeds that memory; you can also append todos later.
